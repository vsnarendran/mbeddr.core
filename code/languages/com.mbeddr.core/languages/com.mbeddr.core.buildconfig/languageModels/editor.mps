...
<model ref="r:03a6131a-45fb-41fe-997e-86ce9462eaef(com.mbeddr.core.buildconfig.editor)">
  ...
  <node concept="24kQdi" id="6GqYvBOf2Xe">
    ...
    <node concept="3EZMnI" id="6yNiuNdx88h" role="6VMZX">
      <node concept="2iRkQZ" id="6yNiuNdx88i" role="2iSdaV" />
      <node concept="3EZMnI" id="6yNiuNdx8dX" role="3EZMnx">
        <node concept="2iRfu4" id="6yNiuNdx8dY" role="2iSdaV" />
        <node concept="VPM3Z" id="6yNiuNdx8dZ" role="3F10Kt">
          <property role="VOm3f" value="false" />
        </node>
        <node concept="3F0ifn" id="6yNiuNdx8ej" role="3EZMnx">
          <property role="3F0ifm" value="neverGenerateThisModel:" />
        </node>
        <node concept="3F0A7n" id="6yNiuNdx8eU" role="3EZMnx">
          <ref role="1NtTu8" to="51wr:6hM2_xVYvfX" resolve="neverGenerateThisModel" />
        </node>
      </node>
    </node>
  </node>
