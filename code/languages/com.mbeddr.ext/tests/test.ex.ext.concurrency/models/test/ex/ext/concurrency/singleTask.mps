...
<model ref="r:9054466d-f8f4-4815-89d0-ec603639c8be(test.ex.ext.concurrency.singleTask)">
  ...
  <node concept="N3F5e" id="73JrkgytXsk">
        ...
        <node concept="c0U19" id="3xRFG9PM86c" role="3XIRFZ">
          ...
          <node concept="1ly_i6" id="7YbLqLwCxHi" role="ggAap">
            <node concept="3XIRFW" id="7YbLqLwCxHj" role="1ly_ph">
              ...
              <node concept="1X3_iC" id="3wTI$uns0iM" role="lGtFl">
                ...
                <node concept="vXAfd" id="3wTI$uns0iL" role="8Wnug" />
              </node>
            </node>
          </node>
        </node>
    ...
    <node concept="lIfQi" id="4Ru$s7zAJgd" role="N3F5h">
      <property role="TrG5h" value="main" />
      <node concept="3cM6IN" id="4Ru$s7zAJge" role="lIfQt">
  ...
  <node concept="2v9HqL" id="73JrkgytYQj">
    <node concept="2AWWZL" id="73JrkgytYRP" role="2AWWZH">
      ...
      <node concept="2uJ1u$" id="5BMpRxKDPHP" role="2uJ1m2">
