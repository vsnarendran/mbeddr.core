...
<model ref="r:eba4931c-54da-4c91-9f45-f1a87a10646c(test.ex.ext.math.mathUser@tests)">
  ...
  <imports>
    <import index="s010" ref="r:2acc83b4-f926-4b0b-bb89-a3afd2afd034(test.ex.ext.math.standalone@tests)" />
  </imports>
  <registry>
  ...
  <node concept="2v9HqL" id="2Gt5ABeTHbg">
    <node concept="2AWWZL" id="2Gt5ABeTHcM" role="2AWWZH">
      <property role="2AWWZJ" value="gcc" />
      <property role="3r8Kw1" value="gdb" />
      <property role="3r8Kxs" value="make" />
      <property role="2AWWZI" value="-std=c99" />
      <property role="1FkSt$" value="-g" />
      <node concept="2uJ1u$" id="5BMpRxKDPHK" role="2uJ1m2">
        <property role="2uJ1ct" value="gcc" />
        <property role="2uJ1bz" value="-g" />
        <property role="2uJ1ci" value="-std=c99" />
      </node>
    </node>
    <node concept="22RD12" id="$ZgyIbUX7C" role="2Q9xDr" />
    <node concept="2eh4Hv" id="$ZgyIbKFxV" role="2Q9xDr" />
  ...
  <node concept="N3F5e" id="2Gt5ABeTHaj">
    ...
    <node concept="N3Fnx" id="$ZgyIbUUIk" role="N3F5h">
      ...
      <node concept="3XIRFW" id="$ZgyIbUUIm" role="3XIRFX">
        ...
        <node concept="2BFjQ_" id="$ZgyIbUUIu" role="3XIRFZ">
          <node concept="3TlMh9" id="$ZgyIbUUIv" role="2BFjQA">
            <property role="2hmy$m" value="0" />
          </node>
        </node>
      </node>
      <node concept="26Vqph" id="$ZgyIbUUIo" role="2C2TGm">
        <property role="2caQfQ" value="false" />
        <property role="2c7vTL" value="false" />
      </node>
      <node concept="19RgSI" id="$ZgyIbUUIp" role="1UOdpc">
        <property role="TrG5h" value="argc" />
        <node concept="26Vqph" id="$ZgyIbUUIq" role="2C2TGm">
          <property role="2caQfQ" value="false" />
          <property role="2c7vTL" value="false" />
        </node>
      </node>
      <node concept="19RgSI" id="$ZgyIbUUIr" role="1UOdpc">
        <property role="TrG5h" value="argv" />
        <node concept="3J0A42" id="$ZgyIbUUIs" role="2C2TGm">
          <property role="2caQfQ" value="false" />
          <property role="2c7vTL" value="false" />
          <node concept="Pu267" id="$ZgyIbUUIt" role="2umbIo">
            <property role="2caQfQ" value="false" />
            <property role="2c7vTL" value="false" />
          </node>
        </node>
    ...
    <node concept="2NXPZ9" id="$ZgyIbUUAy" role="N3F5h">
      <property role="TrG5h" value="empty_1438694076960_5" />
    </node>
    <node concept="2NXPZ9" id="$ZgyIbUUCf" role="N3F5h">
      <property role="TrG5h" value="empty_1438694077113_6" />
    </node>
  </node>
</model>
