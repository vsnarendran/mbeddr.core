...
<model ref="r:5337da22-0172-4f11-9051-cd116bd2204c(com.mbeddr.analyses.cbmc.concurrency.editor)">
  ...
  <node concept="24kQdi" id="i5tJSHdoqD">
    ...
    <node concept="3F0ifn" id="2z5lu9BtVz9" role="6VMZX">
      <property role="3F0ifm" value="this portion of the code is run by a single thread" />
    </node>
  </node>
  ...
  <node concept="24kQdi" id="3EEGwEpK7St">
    ...
    <node concept="3F0ifn" id="2z5lu9Bvlsa" role="6VMZX">
      <property role="3F0ifm" value="ensures that this thread has no dataraces with the functions passed as parameters" />
    </node>
  </node>
  ...
  <node concept="24kQdi" id="1enaVSyBRxN">
    ...
    <node concept="3F0ifn" id="2z5lu9BtVzi" role="6VMZX">
      <property role="3F0ifm" value="this function is run by a single thread at a time (if the second thread enters, the first one already exited)" />
    </node>
  </node>
</model>
