...
<solution name="com.mbeddr.mpsutil.coverage.emma.rt" uuid="c28cee35-0b0d-4e10-90c6-e4af34a08700" moduleVersion="0" pluginKind="PLUGIN_OTHER" compileInMPS="true">
  <models>
    <modelRoot contentPath="${module}" type="default">
      <sourceRoot location="models" />
    </modelRoot>
    <modelRoot contentPath="${module}" type="java_classes">
      <sourceRoot location="lib/emma.jar" />
    </modelRoot>
  </models>
  <stubModelEntries>
    <stubModelEntry path="${module}/lib/emma.jar" />
  </stubModelEntries>
  <sourcePath />
  <dependencies>
  ...
  <languageVersions>
    ...
    <language id="47a1911a-3e8e-4c5e-b6d2-a6ea5fc70f2b" fqName="com.mbeddr.mpsutil.coverage.emma" version="0" />
