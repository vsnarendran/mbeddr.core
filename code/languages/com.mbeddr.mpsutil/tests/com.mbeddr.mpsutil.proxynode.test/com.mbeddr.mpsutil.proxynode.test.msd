...
<solution name="com.mbeddr.mpsutil.proxynode.test" uuid="70de154f-289e-4bbe-b4dd-1783df78b48f" moduleVersion="0" pluginKind="PLUGIN_OTHER" compileInMPS="true">
  <models>
    <modelRoot contentPath="${module}" type="default">
      <sourceRoot location="models" />
    </modelRoot>
    <modelRoot contentPath="${module}" type="default[proxy]">
      <sourceRoot location="models" />
    </modelRoot>
  </models>
  <sourcePath />
  ...
  <dependencyVersions>
    ...
    <module reference="70de154f-289e-4bbe-b4dd-1783df78b48f(com.mbeddr.mpsutil.proxynode.test)" version="0" />
