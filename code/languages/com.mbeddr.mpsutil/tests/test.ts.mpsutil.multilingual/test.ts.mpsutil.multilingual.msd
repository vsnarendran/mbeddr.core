...
<solution name="test.ts.mpsutil.multilingual" uuid="fcca86e0-64c4-4aef-824c-434589a89382" moduleVersion="0" pluginKind="PLUGIN_EDITOR" compileInMPS="true">
  <models>
  ...
  <stubModelEntries>
    <stubModelEntry path="${module}/resources/test.ts.mpsutil.multilingual.resources.jar" />
  </stubModelEntries>
  <sourcePath />
  <dependencies>
  ...
  <languageVersions>
    ...
    <language id="0eba8d68-ca0c-4113-a9e6-19b359352ecf" fqName="test.ts.mpsutil.multilingual.editor.sandbox" version="0" />
  </languageVersions>
  <dependencyVersions>
    ...
    <module reference="fcca86e0-64c4-4aef-824c-434589a89382(test.ts.mpsutil.multilingual)" version="0" />
  </dependencyVersions>
</solution>
