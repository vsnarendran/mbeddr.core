...
c:\cygwin64\bin\sh.exe -c "wget http://ftp.debian.org/debian/pool/main/m/minisat2/minisat2_2.2.1.orig.tar.gz; tar xfz minisat2_2.2.1.orig.tar.gz; mv minisat2-2.2.1 minisat-2.2.1; cd minisat-2.2.1; patch -p1 < ../scripts/minisat-2.2.1-patch;"
